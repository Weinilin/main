...
public class DescriptionParser {
    ...
    private static final String NOON_MIDNIGHT_KEYWORD = "(\\b(due on |on |at |from |to |by |due |)noon\\b)|(\\b(on |at |from |to |due | due on |)midnight\\b)";
    ...
    private static final String MORNING_AFTERNOON_NIGHT_KEYWORD = "(\\b(due on |on |at |from |to |by |due |)(\\d+[.:,](\\d+|)|\\d+)( in (morning|morn)\\b| in afternoon\\b| in night\\b| at night\\b| at afternoon\\b"
    ...
    private static final String DAYS_APART_VOCAB_KEYWORD = "(due on |on |at |from |to |by |due |)(\\b((tomorrow|tmr)\\b|\\b(the\\s|)following day\\b|\\b(the\\s|)next day\\b"
