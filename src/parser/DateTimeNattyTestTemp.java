...
public class DateTimeNattyTestTemp {
    ...
    public void testPastMidnightOrNoonKeyword() {
        ...
        times1.clear();
        times1.add("12:01");
        assertEquals(times1, TimeParser.extractTime("past noon run"));
    }
    ...
    public void testHourApartKeyword() {
        ...
        times1.add("02:30");
        times1.add("05:30");
        DateTimeNatty d2 = new DateTimeNatty(
                "mds sale start at 3,30 for 2 hour");
        assertEquals(times1, d2.getDateList());
        ...
        times1.add("03:30");
        times1.add("05:30");
        DateTimeNatty d1 = new DateTimeNatty(
                "mds sale start at 3.30 for 2 hour");
        assertEquals(times1, d1.getDateList());
    ...
    public void testBeforeNoonOrMidnight() {
        ...
        times.clear();
        times.add("11:59");
        assertEquals(times, TimeParser.extractTime("mds sale before noon"));

        // test before midnight
        times.clear();
        times.add("23:59");
        assertEquals(times, TimeParser.extractTime("before midnight sleep!!!!"));
    }
    ...
    public void testNoonOrMidnight() {
        ...
        times.clear();
        times.add("12:00");
        assertEquals(times, TimeParser.extractTime("mds sale from noon"));

        // test midnight
        times.clear();
        times.add("00:00");
        assertEquals(times, TimeParser.extractTime("at midnight Twilight"));
    }
    ...
    public void testMorningNightAfternoon() {
        ArrayList<String> times = new ArrayList<String>();
        /*
         * // test in night with semicolon ArrayList<String> times = new
         * ArrayList<String>(); times.clear(); times.add("19:45"); DateTimeNatty
         * d1 = new DateTimeNatty("mds sale 7:45 in night."); assertEquals(
         * times, d1.getDateTimeList());
         * 
         * //test in morn with semicolon times.clear(); times.add("06:30");
         * DateTimeNatty d2 = new DateTimeNatty("6:30 in the morn sunshine");
         * assertEquals( times, d2.getDateTimeList());
         * 
         * //test in morning with semicolon times.clear(); times.add("06:30");
         * assertEquals( times, TimeParser
         * .extractTime("mds sale at 6:30 in morning"));
         * 
         * //test in afternoon with semicolon times.clear(); times.add("14:30");
         * DateTimeNatty d3 = new
         * DateTimeNatty("mds sale from 2:30 in afternoon"); assertEquals(
         * times, d3.getDateTimeList());
         * 
         * 
         * // test in night without semicolon times.clear(); times.add("19:00");
         * DateTimeNatty d4 = new DateTimeNatty("mds sale 7 in night");
         * assertEquals( times, d4.getDateTimeList());
         */

        // test in morn without semicolon
        times.clear();
        times.add("06:00");
        assertEquals(times, TimeParser.extractTime("mds sale 6 at morn."));

        // test in morning without semicolon
        times.clear();
        times.add("03:00");
        assertEquals(times, TimeParser.extractTime("mds sale at 3 in morning."));

        // test in afternoon without semicolon
        times.clear();
        times.add("14:00");
        assertEquals(times,
                TimeParser.extractTime("mds sale from 2 in afternoon"));

        // test , connecting mm and hh in time
        times.clear();
        times.add("13:30");
        assertEquals(times,
                TimeParser.extractTime("mds sale from 1,30 in afternoon"));

        // test . connecting mm and hh in time
        times.clear();
        times.add("23:30");
        assertEquals(times,
                TimeParser.extractTime("mds sale from 11.30 in night"));
    }
    ...
    public void testTwelveHourTime() {
        ...
        times.clear();
        times.add("00:00");
        assertEquals(times, TimeParser.extractTime("mds sale 12 am 24/3/2014"));
        ...
        assertEquals(times, TimeParser.extractTime("mds sale 6.30pm"));
        /*
         * //test for time with "," connecting HH and MM times.clear();
         * times.add("03:30"); DateTimeNatty d4 = new
         * DateTimeNatty("mds sale 3:30 am"); assertEquals( times,
         * d4.getDateTimeList());
         */
        // test with <conjunction> 12 hour format
        times.clear();
        times.add("11:00");
        DateTimeNatty d5 = new DateTimeNatty("mds sale start at 11");
        assertEquals(times, d5.getDateList());
    ...
    public void testTimeWithOclock() {
        ...
        times.add("10:00");
        DateTimeNatty d1 = new DateTimeNatty(
                "add go run 5 round on this sun from 10 o’clock");
        assertEquals(times, d1.getDateList());
        ...
        times.clear();
        times.add("11:45");
        assertEquals(times, TimeParser.extractTime("11,45 o'clock go go go"));
    ...
    public void testTimeToTime() {
        ...
        times.add("06:00");
        times.add("18:00");
        assertEquals(times, TimeParser.extractTime("mds sale from 6 - 6pm"));

        // test without symbol of am
        times.clear();
        times.add("01:00");
        times.add("06:00");
        assertEquals(times, TimeParser.extractTime("mds sale from 1 - 6am"));
        ...
        times.add("06:30");
        times.add("10:00");
        DateTimeNatty d1 = new DateTimeNatty("mds sale from 1:30 - 6:30");
        assertEquals(times, d1.getDateList());
        ...
        times.add("01:00");
        times.add("06:00");
        assertEquals(times, TimeParser.extractTime("mds sale from 1am - 6am"));
        ...
        times.add("01:30");
        times.add("06:30");
        assertEquals(times, TimeParser.extractTime("mds sale from 1,30-6,30am"));
        ...
        times.add("13:00");
        times.add("18:00");
        assertEquals(times, TimeParser.extractTime("mds sale from 1 to 6pm"));

        // test without am or pm
        times.clear();
        times.add("01:30");
        times.add("06:30");
        assertEquals(times, TimeParser.extractTime("mds sale from 1,30-6,30"));
    }
    ...
    public void testHourFormat() {
        ...
        times.clear();
        times.add("11:20");
        assertEquals(times, TimeParser.extractTime("mds sale 11:20"));

        // test with symbol "."
        times.clear();
        times.add("23:20");
        assertEquals(times, TimeParser.extractTime("mds sale 23.20"));

        // test with symbol ","
        times.clear();
        times.add("00:20");
        assertEquals(times, TimeParser.extractTime("mds sale 00,20"));
    }
    ...
    public void test24HourWithoutPunc() {
        ...
        times1.clear();
        times1.add("11:00");
        DateTimeNatty d1 = new DateTimeNatty("add go run one round on this sun from 10 o’clock to 11 am");
        assertEquals(times1, d1.getDateList());
        assertEquals(times1, d1.getTimeList());
        ...
        times1.clear();
        times1.add("13:00");
        assertEquals(times1, TimeParser.extractTime("mds sale start at 1300"));
    }
    ...
    public void testPosition() {
         ...
         * before midnight then detect noonbut the arrangement of the timing
         * should be noon --> before midnight
         */
        ArrayList<String> times = new ArrayList<String>();
        times.clear();
        times.add("12:00");
