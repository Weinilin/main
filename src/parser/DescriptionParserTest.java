...
public class DescriptionParserTest {
	...
	public void withHashTagTest() throws Exception {
		...
		//~~ more than 2
		MainParser m5 = new MainParser("CS2103T ~tomorrow~ la la la on ~ooooo~ at 3pm 23/9 ");
        userInputLeftOver = m5.getUserInputLeft();
		DescriptionParser d7 = new DescriptionParser("CS2103T ~tomorrow~ la la la on ~ooooo~ at 3pm 23/9 ", userInputLeftOver);
		...
		MainParser m8 = new MainParser("CS2103T assignment on ~ 2nd december ~ at");
        userInputLeftOver = m8.getUserInputLeft();
        DescriptionParser d10 = new DescriptionParser("CS2103T assignment on ~ 2nd december ~ at", userInputLeftOver);
        assertEquals(d10.getDescription(), "CS2103T assignment on 2nd december at"); 
